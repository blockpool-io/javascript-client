...
module.exports = class ApiClient {
  ...
  static async selectApiPeer (peers) {
    for (const peer of peers) {
      ...
      if (config && config.plugins && config.plugins['@blockpool-io/core-api'] &&
      config.plugins['@blockpool-io/core-api'].enabled) {
        return {
          ...peer,
          port: config.plugins['@blockpool-io/core-api'].port
        }
      }
    }
